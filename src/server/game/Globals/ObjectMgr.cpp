...
void ObjectMgr::LoadItemTemplates()
{
    ...
    do
    {
        ...
        //ItemInfo.holidayId               = fields[116].GetUInt32();
       ...
       /* if (ItemPrototype.holidayId && !sHolidaysStore.LookupEntry(ItemPrototype.holidayId))
        {
            sLog->outErrorDb("Item (Entry: %u) has wrong HolidayId value (%u)", entry, ItemPrototype.holidayId);
            ItemPrototype.holidayId = 0;
        }*/
